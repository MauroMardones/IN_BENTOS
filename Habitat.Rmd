...
draga_labels <- draga_sf %>%
  filter(Estacion %in% c("249", "232", "234", "232R"))
...
inset_map <- ggplot() +
  geom_sf(data = europe_map, fill = "#fee8c8", color = "gray50") +
  geom_rect(aes(xmin = -7.2, xmax = -6.3, ymin = 36.65, ymax = 37.3),
            fill = NA, color = "red",  size = 0.8) +
  coord_sf(xlim = c(-12, 20), ylim = c(34, 50)) +
  theme_void()
inset_map
