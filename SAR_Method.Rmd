...
<!-- --- -->
<!-- title: "Análisis exploratorio y preparación base de datos variables ambientales en la PA" -->
...
```{r esq, echo=FALSE, out.width = "50%", fig.align='center', fig.cap="\\label{esq}Umbrarl de definiciones para calculo de velocidad de arrantre"}
