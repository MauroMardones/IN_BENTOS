...
```{r}
CV_2018 <- read_csv2(here("DATOS/Cajas verdes chirla/Dragas_2018_2024/EXPORT_DRAGAS_2018.csv", 
...
diahis1819 <- ggplot()+
  geom_histogram(aes(CV_18_19f$DIA), 
                     col=2,
                     fill="white",
                 binwidth = 1)+
  theme_few()
meshis1819 <- ggplot()+
  geom_histogram(aes(CV_18_19f$MES), 
                     col=3,
                     fill="white",
                 binwidth = 1)+
  theme_few()
velhis1819 <- ggplot()+
  geom_histogram(aes(CV_18_19f$VELOCIDAD), 
                     col=4,
                     fill="white",
                 binwidth = 0.1)+
  theme_few()
ggarrange(diahis1819,
          meshis1819,
          velhis1819,
          ncol=3)
```
